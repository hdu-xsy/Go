...
type MenuModifyPageSercice struct {

}
func (s *MenuModifyPageSercice) BeginRequest(ctx iris.Context) {
	if auth, _ := Entity.Sess.Start(ctx).GetBoolean("authenticated"); !auth {
		ctx.Redirect("/adminlogin")
		return
	}
}
func (s *MenuModifyPageSercice) EndRequest(ctx iris.Context) {}
func (s *MenuModifyPageSercice) Get(ctx iris.Context) {
	h1 := redisdao.Get("h1")
	ac := redisdao.Get("ac")
	menuList := menudao.GetAll()
	ctx.ViewData("h1",h1)
	ctx.ViewData("ac",ac)
	ctx.ViewData("menuList",menuList)
	ctx.View("menumodify.html")
}

type H1Modify struct {

}
func (s *H1Modify) Update(ctx iris.Context) {
	redisdao.Set("h1",ctx.PostValue("h1"))
	ctx.Redirect("/menumodify")
	return
}
type ACModify struct {

}
func (s *ACModify) Update(ctx iris.Context) {
	redisdao.Set("ac",ctx.PostValue("ac"))
	ctx.Redirect("/menumodify")
	return
}
...
func (s *MenuInsert) Update(ctx iris.Context) {
	menudao.Insert(Entity.Menu{Name:ctx.PostValue("menu")})
	ctx.Redirect("/menumodify")
	return
}
...
func (s *MenuDelete) Update(ctx iris.Context) {
	id,_ :=strconv.ParseInt(ctx.PostValue("Id"),10,64)
	menudao.Delete(Entity.Menu{Id:id,Name:ctx.PostValue("Name")})
	ctx.Redirect("/menumodify")
	return
}
...
func (s *MenuModify) Update(ctx iris.Context) {
	id,_ :=strconv.ParseInt(ctx.PostValue("Id"),10,64)
	menudao.Motify(Entity.Menu{Id:id,Name:ctx.PostValue("Name")})
	ctx.Redirect("/menumodify")
	return
}